defmodule KitchenRecipeWeb do
  ...
  This can be used in your application as:
      ...
      use KitchenRecipeWeb, :controller
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: KitchenRecipeWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {KitchenRecipeWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: KitchenRecipeWeb.Router,
        statics: KitchenRecipeWeb.static_paths()
    end
  end
