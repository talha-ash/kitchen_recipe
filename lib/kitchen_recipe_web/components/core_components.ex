defmodule KitchenRecipeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KitchenRecipeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KitchenRecipeWeb.Gettext, "errors", msg, opts)
    end
  end
